...
namespace types {
PROTOBUF_CONSTEXPR Platform::Platform(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.os_features_)*/{}
...
struct PlatformDefaultTypeInternal {
  PROTOBUF_CONSTEXPR PlatformDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PlatformDefaultTypeInternal _Platform_default_instance_;
}  // namespace types
}  // namespace containerd
static ::_pb::Metadata file_level_metadata_types_2fplatform_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_types_2fplatform_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_types_2fplatform_2eproto = nullptr;

const uint32_t TableStruct_types_2fplatform_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::containerd::types::Platform, _impl_.os_),
  PROTOBUF_FIELD_OFFSET(::containerd::types::Platform, _impl_.architecture_),
  PROTOBUF_FIELD_OFFSET(::containerd::types::Platform, _impl_.variant_),
  PROTOBUF_FIELD_OFFSET(::containerd::types::Platform, _impl_.os_version_),
  PROTOBUF_FIELD_OFFSET(::containerd::types::Platform, _impl_.os_features_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::containerd::types::Platform)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::containerd::types::_Platform_default_instance_._instance,
};

const char descriptor_table_protodef_types_2fplatform_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024types/platform.proto\022\020containerd.types"
  "\"f\n\010Platform\022\n\n\002os\030\001 \001(\t\022\024\n\014architecture"
  "\030\002 \001(\t\022\017\n\007variant\030\003 \001(\t\022\022\n\nos_version\030\004 "
  "\001(\t\022\023\n\013os_features\030\005 \003(\tB2Z0github.com/c"
  "ontainerd/containerd/api/types;typesb\006pr"
  "oto3"
  ;
static ::_pbi::once_flag descriptor_table_types_2fplatform_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_types_2fplatform_2eproto = {
    false, false, 204, descriptor_table_protodef_types_2fplatform_2eproto,
    "types/platform.proto",
    &descriptor_table_types_2fplatform_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_types_2fplatform_2eproto::offsets,
    file_level_metadata_types_2fplatform_2eproto, file_level_enum_descriptors_types_2fplatform_2eproto,
    file_level_service_descriptors_types_2fplatform_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_types_2fplatform_2eproto_getter() {
  return &descriptor_table_types_2fplatform_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_types_2fplatform_2eproto(&descriptor_table_types_2fplatform_2eproto);
namespace containerd {
namespace types {
...
Platform::Platform(const Platform& from)
  ...
  Platform* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.os_features_){from._impl_.os_features_}
    , decltype(_impl_.os_){}
...
inline void Platform::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.os_features_){arena}
    , decltype(_impl_.os_){}
    , decltype(_impl_.architecture_){}
    , decltype(_impl_.variant_){}
    , decltype(_impl_.os_version_){}
...
inline void Platform::SharedDtor() {
  ...
  _impl_.os_features_.~RepeatedPtrField();
  _impl_.os_.Destroy();
...
const char* Platform::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "containerd.types.Platform.os"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "containerd.types.Platform.architecture"));
        } else
          goto handle_unusual;
        continue;
      // string variant = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "containerd.types.Platform.variant"));
        } else
          goto handle_unusual;
        continue;
      // string os_version = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "containerd.types.Platform.os_version"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          do {
            ptr += 1;
            auto str = _internal_add_os_features();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "containerd.types.Platform.os_features"));
...
uint8_t* Platform::_InternalSerialize(
  ...
  if (!this->_internal_os_version().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "containerd.types.Platform.os_version");
    target = stream->WriteStringMaybeAliased(
        4, this->_internal_os_version(), target);
  }

  // repeated string os_features = 5;
  for (int i = 0, n = this->_internal_os_features_size(); i < n; i++) {
    const auto& s = this->_internal_os_features(i);
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      s.data(), static_cast<int>(s.length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "containerd.types.Platform.os_features");
...
// @@protoc_insertion_point(message_byte_size_start:containerd.types.Platform)
  ...
  // repeated string os_features = 5;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.os_features_.size());
  for (int i = 0, n = _impl_.os_features_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.os_features_.Get(i));
  }
...
void Platform::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.os_features_.MergeFrom(from._impl_.os_features_);
  if (!from._internal_os().empty()) {
...
void Platform::InternalSwap(Platform* other) {
  ...
  _impl_.os_features_.InternalSwap(&other->_impl_.os_features_);
...
::PROTOBUF_NAMESPACE_ID::Metadata Platform::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_types_2fplatform_2eproto_getter, &descriptor_table_types_2fplatform_2eproto_once,
      file_level_metadata_types_2fplatform_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::containerd::types::Platform*
Arena::CreateMaybeMessage< ::containerd::types::Platform >(Arena* arena) {

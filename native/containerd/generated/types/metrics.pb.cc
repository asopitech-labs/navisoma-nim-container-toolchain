...
static ::_pb::Metadata file_level_metadata_types_2fmetrics_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_types_2fmetrics_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_types_2fmetrics_2eproto = nullptr;

const uint32_t TableStruct_types_2fmetrics_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::containerd::types::Metric, _impl_.timestamp_),
  PROTOBUF_FIELD_OFFSET(::containerd::types::Metric, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::containerd::types::Metric, _impl_.data_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::containerd::types::Metric)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::containerd::types::_Metric_default_instance_._instance,
};

const char descriptor_table_protodef_types_2fmetrics_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023types/metrics.proto\022\020containerd.types\032"
  "\031google/protobuf/any.proto\032\037google/proto"
  "buf/timestamp.proto\"g\n\006Metric\022-\n\ttimesta"
  "mp\030\001 \001(\0132\032.google.protobuf.Timestamp\022\n\n\002"
  "id\030\002 \001(\t\022\"\n\004data\030\003 \001(\0132\024.google.protobuf"
  ".AnyB2Z0github.com/containerd/containerd"
  "/api/types;typesb\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_types_2fmetrics_2eproto_deps[2] = {
  &::descriptor_table_google_2fprotobuf_2fany_2eproto,
  &::descriptor_table_google_2fprotobuf_2ftimestamp_2eproto,
};
static ::_pbi::once_flag descriptor_table_types_2fmetrics_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_types_2fmetrics_2eproto = {
    false, false, 264, descriptor_table_protodef_types_2fmetrics_2eproto,
    "types/metrics.proto",
    &descriptor_table_types_2fmetrics_2eproto_once, descriptor_table_types_2fmetrics_2eproto_deps, 2, 1,
    schemas, file_default_instances, TableStruct_types_2fmetrics_2eproto::offsets,
    file_level_metadata_types_2fmetrics_2eproto, file_level_enum_descriptors_types_2fmetrics_2eproto,
    file_level_service_descriptors_types_2fmetrics_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_types_2fmetrics_2eproto_getter() {
  return &descriptor_table_types_2fmetrics_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_types_2fmetrics_2eproto(&descriptor_table_types_2fmetrics_2eproto);
namespace containerd {
namespace types {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "containerd.types.Metric.id"));
        } else
          goto handle_unusual;
        continue;
...
void Metric::InternalSwap(Metric* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Metric, _impl_.data_)
      + sizeof(Metric::_impl_.data_)
      - PROTOBUF_FIELD_OFFSET(Metric, _impl_.timestamp_)>(
...
::PROTOBUF_NAMESPACE_ID::Metadata Metric::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_types_2fmetrics_2eproto_getter, &descriptor_table_types_2fmetrics_2eproto_once,
      file_level_metadata_types_2fmetrics_2eproto[0]);
}
...
template<> PROTOBUF_NOINLINE ::containerd::types::Metric*
Arena::CreateMaybeMessage< ::containerd::types::Metric >(Arena* arena) {
